	...
	<div className="flex flex-col w-full">
		...
		<div className="flex flex-wrap items-center mt-2 mb-1 space-x-2">
			<div className="flex">
				<button type="button" title="Rate 1 stars" aria-label="Rate 1 stars">
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-6 h-6 text-sky-500">
		...
		<div className="flex flex-col mt-4">
			<div className="flex items-center space-x-1">
				...
				<div className="flex-1 h-4 overflow-hidden rounded-sm bg-gray-400">
					<div className="bg-sky-500 h-4 w-5/6"></div>
				</div>
			...
			<div className="flex items-center space-x-1">
				...
				<div className="flex-1 h-4 overflow-hidden rounded-sm bg-gray-400">
					<div className="bg-sky-500 h-4 w-4/6"></div>
				</div>
			...
			<div className="flex items-center space-x-1">
				...
				<div className="flex-1 h-4 overflow-hidden rounded-sm bg-gray-400">
					<div className="bg-sky-500 h-4 w-3/6"></div>
				</div>
			...
			<div className="flex items-center space-x-1">
				...
				<div className="flex-1 h-4 overflow-hidden rounded-sm bg-gray-400">
					<div className="bg-sky-500 h-4 w-2/6"></div>
				</div>
			...
			<div className="flex items-center space-x-1">
				...
				<div className="flex-1 h-4 overflow-hidden rounded-sm bg-gray-400">
					<div className="bg-sky-500 h-4 w-1/6"></div>
				</div>
