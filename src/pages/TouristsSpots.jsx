      ...
      <div className=" bg-base-200">
        ...
        <div className="card-body">
          <h2 className="card-title">
            Country Name:{" "}
            <span className="font-light ml-3">{country_Name}</span>{" "}
          </h2>
          <h3 className="font-bold uppercase">
            Tourists Spot:{" "}
            <span className="font-light ml-3">{tourists_spot_name}</span>
          </h3>
          <div className="flex">
            <p>
              <span className="font-semibold ">Average Cost:</span>{" "}
              <span className="ml-2 font-light">${average_cost}</span>
            </p>
            <p>
              <span className="font-semibold">Travel Time: </span>
              <span className="ml-2 font-light">{travel_time} day</span>
            </p>
          </div>
          <div className=" mt-8">
            <Link to={`/detail/${_id}`}>
